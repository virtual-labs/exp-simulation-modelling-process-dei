...
:--|:--|
<b> Lab | <b> 3D Printing
<b> Experiment|     <b> To simulate the Fused Deposition Modelling (FDM) process.
<h5> About the Experiment : </h5>

This experiment is about the basics and concept of the Fused Deposition Modelling (FDM) process.
