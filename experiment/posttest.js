...
/////////////// Write the MCQ below in the exactly same described format ///////////////
  ...
  const myQuestions = [
    ...
    {
      question: " What is function of extruder nozzle:",  ///// Write the question inside double quotes
      answers: {
        a: "To heat the filament.",                  ///// Write the option 1 inside double quotes
        b: "Level the bed.",                  ///// Write the option 2 inside double quotes
        c: "To extrude the material.",                  ///// Write the option 3 inside double quotes
